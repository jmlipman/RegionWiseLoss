...
class NetworkTrainer(object):
    ...
    def run_training(self):
        ...
        while self.epoch < self.max_num_epochs:
            ...
            #print("I'm done with one epoch")
            #sleep(10)
            #print("Gonna start the next epoch")
            task_name = "Task102_Brats18"
            task_name = "Task103_Kits19"
            task_name = "Task101_ACDC17"
            task_id = "101"
            task_labels = "1 2 3"
            outfolder = "/home/miguelv/nnunet/results/exp3/Boundary/Equal-CE/"

            # COMMANDS USED IN THE THIRD EXPERIMENT
            if len(os.listdir(outfolder + "1")) < 150:
                outfolder += "1/"
            elif len(os.listdir(outfolder + "2")) < 150:
                outfolder += "2/"
            elif len(os.listdir(outfolder + "3")) < 150:
                outfolder += "3/"
            else:
                raise Exception("Folders 1, 2, 3 are filled!")

            inference_command = "nnUNet_predict -i /media/miguelv/HD1/Datasets/nnUNet_data/nnUNet_raw_data_base/nnUNet_raw_data/" + task_name + "/imagesTs/ -o /media/miguelv/HD1/Datasets/nnUNet_data/nnUNet_raw_data_base/nnUNet_raw_data/" + task_name + "/preds_tmp -t " + task_id + " -m 2d -f all -chk model_latest"
            evaluation_command = "nnUNet_evaluate_folder -ref /media/miguelv/HD1/Datasets/nnUNet_data/nnUNet_raw_data_base/nnUNet_raw_data/" + task_name + "/labelsTs/ -pred /media/miguelv/HD1/Datasets/nnUNet_data/nnUNet_raw_data_base/nnUNet_raw_data/" + task_name + "/preds_tmp/ -l " + task_labels
            move_command = "mv /media/miguelv/HD1/Datasets/nnUNet_data/nnUNet_raw_data_base/nnUNet_raw_data/" + task_name + "/preds_tmp/summary.json " + outfolder + "summary-" + str(self.epoch + 1) + ".json"
            delete_command = "/bin/rm /media/miguelv/HD1/Datasets/nnUNet_data/nnUNet_raw_data_base/nnUNet_raw_data/" + task_name + "/preds_tmp -R"
            ...
            if self.epoch % 2 == 1:
                ...
                # Run evaluation > save output somewhere
            ...
            # COMMANDS USED IN THE SECOND EXPERIMENT
            # In the second expeirments, commands were the same but i only run them in the last epocH
            # Only measure the results in the last epoch (50)
            if self.epoch == 49:
                file_n = len(os.listdir(outfolder)) + 1
                inference_command = "nnUNet_predict -i /media/miguelv/HD1/Datasets/nnUNet_data/nnUNet_raw_data_base/nnUNet_raw_data/" + task_name + "/imagesTs/ -o /media/miguelv/HD1/Datasets/nnUNet_data/nnUNet_raw_data_base/nnUNet_raw_data/" + task_name + "/preds_tmp -t " + task_id + " -m 2d -f all -chk model_latest"
                evaluation_command = "nnUNet_evaluate_folder -ref /media/miguelv/HD1/Datasets/nnUNet_data/nnUNet_raw_data_base/nnUNet_raw_data/" + task_name + "/labelsTs/ -pred /media/miguelv/HD1/Datasets/nnUNet_data/nnUNet_raw_data_base/nnUNet_raw_data/" + task_name + "/preds_tmp/ -l " + task_labels
                move_command = "mv /media/miguelv/HD1/Datasets/nnUNet_data/nnUNet_raw_data_base/nnUNet_raw_data/" + task_name + "/preds_tmp/summary.json " + outfolder + "summary-" + str(file_n) + ".json"
                delete_command = "/bin/rm /media/miguelv/HD1/Datasets/nnUNet_data/nnUNet_raw_data_base/nnUNet_raw_data/" + task_name + "/preds_tmp -R"
                # Run inference
                os.system(inference_command)
                # Run evaluation > save output somewhere
            ...
            """
            # COMMANDS USED IN THE FIRST EXPERIMENT
            # These allow nnUNet to run evaluation on the test/validation set
            # After each epoch
            ...
            # Run inference
            # Run evaluation, save it somewhere.
    ...
    def maybe_save_checkpoint(self):
        ...
        :return:
        """
        print(self.save_intermediate_checkpoints, self.epoch, self.save_every)
